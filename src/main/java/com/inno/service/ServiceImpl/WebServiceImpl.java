...
public class WebServiceImpl implements WebService{
    private static WebDao w=new WebDaoImpl();
    @Override
    ...
    public void clean(List<Map<String, Object>> list) throws IOException {
        ...
        for(Map<String,Object> mm:list) {
            if (mm.get("comp_full_name") != null&&mm.get("web_url")!=null) {
                ...
                String[] va=web_url(mm.get("web_url").toString(), quan,mm.get("source_y").toString());
                if(va!=null) {
                    String weburl = va[0];
                    String fen = va[1];
        ...
        if(Dup.nullor(key)) {
            ...
            if(doc!=null){
                if(doc.body().contains(va)&&(doc.statusCode()==200||doc.statusCode()==302)){
                    ...
                    return new String[]{doc.url().toString(),String.valueOf(80+Integer.parseInt(yuanfen(source)))};
